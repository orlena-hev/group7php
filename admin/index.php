...
//exit ("Доступ на эту страницу разрешен только зарегистрированным пользователям. Если вы зарегистрированы, то войдите на сайт под своим логином и паролем<br><a href='http://phpstart.com:90/'>Главная страница</a>");
//}
?>
...
<div id="main_container">
    ...
    <div class="right_header">Welcome Admin, <a href="#">Visit site</a> | <a href="#" class="messages">(3) Messages</a> | <a href="http://phpstart.com:90/admin/logout.php" class="logout">Logout</a></div>
    <div id="clock_a"></div>
    </div>
      ...
      <?php
        ...
        if($resul)
        {
            ...
            echo '<tr>
                ...
                <th scope="col" class="rounded">Обр.</th>
            ...
            echo '<tfoot>';
            echo '<tr>
            <td colspan="6" class="rounded-foot-left"><em>Инфо</em></td>
